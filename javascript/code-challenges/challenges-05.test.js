...
const addValues = (arr) => {
  // Solution code here...
  const reduceCallback = (previousNumber, currentNumber) => previousNumber + currentNumber;
...
const addPurchases = (arr) => {
  // Solution code here...
  const reduceCallback = (accumulator, itemObject) => accumulator + itemObject.purchasePrice;
  return arr.reduce(reduceCallback, 0);
};
...
// const countNumberOfElements = (arr) => {
  // Solution code here...
  // const reduceCallback = (accumulator, currentElement) => accumulator + 
// };
...
const returnNames = (arr) => {
  // Solution code here...
  const reduceCallback = (acc, characterObject) => {
    console.log(acc);
    acc + characterObject.name;
  };
