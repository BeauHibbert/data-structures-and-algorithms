...
const totalSum = (input) => {
  // Solution code here...
  console.log(input);
  let totalReduced = input.reduce((a, b) => {
    console.log('a', a);
    console.log('b', b);
    let aReduced = a.reduce((acc, current) => {
      return acc+current;
    });
    console.log('aReduced', aReduced);
    let bReduced = b.reduce((acc, current) => {
      return acc+current;
    });
    console.log('bReduced', bReduced);
    a = aReduced + bReduced;
  });
  return totalReduced;
};
